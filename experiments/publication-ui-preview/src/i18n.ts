...
const en={
  ...
  paused:'Paused',saved_session:'Saved session',runtime_status:'Working…',partial_processing:'Finishing a partial session…',restart_required:'Restart required before another recording',recordingEnding:'finishing recording',
...
const ru:Dictionary={
  ...
  session_finished:'Сессия завершена · модели выгружены',paused:'Пауза',saved_session:'Сохранённая сессия',runtime_status:'Работаю…',partial_processing:'Завершаю неполную сессию…',restart_required:'Перед новой записью нужен перезапуск',recordingEnding:'завершение записи',
...
const he:Dictionary={
  ...
  app_closed:'היישום נסגר',finishing:'מסיים את העיבוד…',cancelling:'מבטל את יתרת העיבוד…',session_finished:'ההפעלה הסתיימה · המודלים שוחררו',paused:'מושהה',saved_session:'הפעלה שמורה',runtime_status:'מעבד…',partial_processing:'מסיים הפעלה חלקית…',restart_required:'נדרשת הפעלה מחדש לפני הקלטה נוספת',
